...
export let processIncludedFileWxsDependencies: ((componentTags: unknown, includePath: string, scriptModule: unknown[], components: Record<string, unknown>, processedPaths?: Set<string>, ctx?: import('../../../../packer/types.ts').PackerContext) => void) | undefined
