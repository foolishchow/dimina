...
const outputPath = path.resolve(scriptDir, '../src/compiler/core/compatibility-reference.js')
...
// Keep this file in sync by running: pnpm --filter @dimina/bundler sync:compat
...
if (checkOnly) {
	if (currentOutput !== output) {
		...
		console.error('[compat] Run: pnpm --filter @dimina/bundler sync:compat')
		process.exitCode = 1
	}
	else {
