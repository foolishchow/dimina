...
| H2 registry 实体化 | **`draft`**（子门 [`fe-tools-hmr-registry-materialize`](../fe-tools-hmr-registry-materialize/README.md)） | L+ | 替代 legacy compile-target；**F-H2-1 viewParseWalk/buildCompileCss monolithic 须拆分 L/C/E 三阶段**（非"包装"，规模升级）；D-REG-1 渐进非 dual-path + D-REG-2/3 load/stage 归属 |
