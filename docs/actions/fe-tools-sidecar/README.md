...
| TS-3 | 编排可选拆包与 sdk 深改边界 | pending / 可 deferred；控制面见 [`fe-tools-bundler-session`](../fe-tools-bundler-session/README.md)（`ready`） |
