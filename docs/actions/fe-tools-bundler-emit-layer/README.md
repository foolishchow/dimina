...
- Status: `ready`
- Updated: 2026-09-15（R8 清理残留；D-E-1..12 全收敛；实施未授权）
...
| 2026-09-15 | **Review R8（F1-F5）清理残留**：F1 🟠 design Status "冻结"→draft；F2 🟠 plan 引用已删节号 §8/§10→§7 签名+§8 决策表；F3 🟡 决策表旧编号 R5-F1/R2-C*→D-E-9..12；F4 🟡 三件套 Status "R7"→R8；F5 🟡 plan 消融注脚去掉 R7-F6 引用。**升 `ready`** |
