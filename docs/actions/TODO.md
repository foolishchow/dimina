...
- [`fe-tools-fingerprints-persist`](fe-tools-fingerprints-persist/README.md)（**`draft`**）— watch-plan 持久化 fingerprints 到 PackerSessionState，content-based dedup。增量前置 G2。
