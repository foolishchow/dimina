...
Packer 下一刀（当前 draft）：
- [`fe-tools-packer-context`](fe-tools-packer-context/README.md)（**`ready`**）— PackerContext 真 I/O + Graph 路 2（D-PC-0..11 已冻；10 轮 review pass）
