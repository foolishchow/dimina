...
- [`fe-tools-style-cssnano-gate`](fe-tools-style-cssnano-gate/README.md)（**`ready`**）— cssnano gate `DIMINA_COMPILER_DIFF_VERIFY`（loader 迁 emit 正本；parse-walk legacy fallback）
