...
**review round 1-34 findings 全修正**（F1-F12 round 1-3 + F-R4-1/2/3 + F-R5-1/2 round 4-6 + F-R7-1/2/3 + F-R8-1 + F-R9-2 round 7-9 + F-R10-1/2 + F-R11-1/2 round 10-12 + F-R13-1/2/3 + F-R14-1/2 round 13-14 + F-R18-1/2/3 + F-R19-4 round 18-19 + F-R22-1/2/3 round 22 + F-R26-1/2/3 round 26 + F-R30-1 round 30 + F-R34-1 round 34：全维度 + 中间层 + 目录 + type + import 链 + **outputMode 信号 lock（P-O1/P-O2 skipMaterialize boolean 过渡，P-O3 后 request.outputMode 'dev'\|'disk' enum，字段名 outputMode 避免 compile mode 'build'\|'dev' 冲突）**）。design.draft §2.0 方案 B + D-O1..7 + D-OL1..4 + §4 风险 + §6 emit/ 目录演进。
