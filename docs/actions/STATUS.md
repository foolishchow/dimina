...
| `fe-tools-packer-research` | `in_progress` | [README](fe-tools-packer-research/README.md) | Packer extraction 可行性研究：4 焊点方法级分析 + 可抽提性评估 + API 草案 + 决策建议。15 轮 review 收敛（23 findings 全修正）。research only。 | 2026-09-20 |