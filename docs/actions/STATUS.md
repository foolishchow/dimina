...
| `fe-tools-compiler-target` | `draft` | [README](fe-tools-compiler-target/README.md) | 产物形态切面收敛：CompileTarget 描述 + 阶段派生（E1–E7 实锚）；行为 0；source audit 完成，5 项待定后升 ready。 | 2026-09-14 |
