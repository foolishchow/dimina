...
| `fe-tools-module-convergence` | `draft` | [README](fe-tools-module-convergence/README.md) | 推进 Packer 形状伞：MC0 graph 正确性 → MC3a deriveFromGraph 函数（entry→graph→modules→code）。D-MC-0 选 A（code 不上图）。MC3b/MC3c/MC1/MC2 deferred。 | 2026-09-21 |
