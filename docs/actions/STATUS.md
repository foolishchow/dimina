...
| `compiler-configurable` | `draft` | [README](compiler-configurable/README.md) | CF-1：统一配置框架；`esTarget.{logic,view}` 双字段；minify/sourcemap；dev 默认不 minify。实施在 CF-4 后。 | 2026-09-10 |
