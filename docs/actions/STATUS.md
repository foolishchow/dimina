...
| `fe-tools-compiler-layering` | `draft` | [README](fe-tools-compiler-layering/README.md) | compiler 分层：L0 目录归位（平铺→域分组+wxs 独立）+ L1 wxml dom 抽象（transform 去 cheerio 污染）+ L2 napi parser 接入；三门口径已定，4 项待定。 | 2026-09-15 |
