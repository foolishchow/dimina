...
| `fe-tools-fingerprints-persist` | `ready` | [README](fe-tools-fingerprints-persist/README.md) | watch-plan 持久化 fingerprints 到 PackerSessionState；content-based dedup 过滤 mtime-only false positives。D-FP-1..8 冻。6 轮 review findings 修正闭环。增量前置 G2。 | 2026-10-07 |
