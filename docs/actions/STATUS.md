...
| `fe-tools-module-invalidation` | `ready` | [README](fe-tools-module-invalidation/README.md) | 刀 2：6 轮 readiness review 收敛（R1–R6: 4→4→2→1→1→0）；D-IV-1..9 已冻（logic-only / 双挂 API）；升 in_progress 另授。 | 2026-09-20 |
