...
| `fe-tools-compiler-layering` | `draft` | [README](fe-tools-compiler-layering/README.md) | compiler 目录归位（方案 A 两轴：view/logic/style + core/pipeline；wxml→view 域名修正；wxs 抽出；view-compiler 2420 行拆散归位）；纯移动唯一门；3 项待定。 | 2026-09-15 |
