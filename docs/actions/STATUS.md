...
| `fe-tools-module-centric` | `ready` | [README](fe-tools-module-centric/README.md) | Module 一等公民伞：D-MF-1 已封；MF0 文档门 pass；M1 已立 draft。未授改 src。 | 2026-09-19 |
...
| `fe-tools-module-result-cache` | `ready` | [README](fe-tools-module-result-cache/README.md) | 刀 3：D-RC-1..4 已冻（B 独立 ModuleResultCache / α session-only / I IPC 回填 / watch-plan 触发）；升 in_progress 另授。 | 2026-09-20 |
