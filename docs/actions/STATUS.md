...
| `fe-tools-sidecar` | `draft` | [README](fe-tools-sidecar/README.md) | Umbrella（draft）；TS-2 IR deferred；目录归置 [`fe-tools-bundler-layout`](_archive/complete/fe-tools-bundler-layout/README.md) 已 **complete**；近端候补：`runBuild` 阶段化（未 formalize）。 | 2026-09-12 |
