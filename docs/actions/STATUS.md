...
| `fe-tools-wxml-parser-dist` | `draft` | [README](fe-tools-wxml-parser-dist/README.md) | napi 分发矩阵：P0 CI 止血 + `.node` 退 git；P1 五平台子包 + 双态解析 + 发版流；D-WX-1..8 全拍板（会发布/即退/无预算）；待定清空。 | 2026-09-15 |
