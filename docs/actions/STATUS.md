...
| `fe-tools-module-cache` | `complete` | [README](_archive/complete/fe-tools-module-cache/README.md) | worker 内层：MC1 失败缓存 + D-MC-3 选项 B / MC2 style compileRes key 加 minify 维度 + D-MC-5 判定 / MC3 mock worker 测例（481 全绿）。消融 ×3。已归档。 | 2026-09-10 |
