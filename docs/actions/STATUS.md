...
| `hmr-l2-l3` | `draft` | [README](hmr-l2-l3/README.md) | Umbrella gate A3：Web 容器 dev-only L2 CSS 热替换 + L3 模板热重挂（module replace + 页面 remount + setupData 快照回放）；边界明确锁定 Web 容器。 | 2026-09-08 |
