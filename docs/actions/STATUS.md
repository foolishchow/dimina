...
| `fe-tools-wxml-refactor` | `ready` | [README](fe-tools-wxml-refactor/README.md) | W1 23 函数归位 + W2 标准 Document + W3 默认 napi；D-WR-1..9；F-WR-R1/R2/R3 文档修已合；实施待授权。 | 2026-09-15 |
