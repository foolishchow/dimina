...
| `fe-tools-bundler-emit-memfs` | `ready` | [README](fe-tools-bundler-emit-memfs/README.md) | 阶段 2：dev memfs（产物不落盘）；D-MM-1..6 全拍板：方案 1 直读 BuildModel + materialize dev 跳过 + 冷路径保留写盘。 | 2026-09-20 |
