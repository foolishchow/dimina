...
| `fe-tools-bundler-output-pure` | `ready` | [README](fe-tools-bundler-output-pure/README.md) | 阶段 1：worker 无 fs / 干净的 output（方案 C）；output.write→postEntry 纯 postMessage；emitEntry 删 outputEnv；collectOutput 全链路清理；materialize 不动。 | 2026-09-16 |
