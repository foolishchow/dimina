...
| `fe-tools-style-minify-gate` | `in_progress` | [README](fe-tools-style-minify-gate/README.md) | style minifyCss（esbuild）gate `DIMINA_COMPILER_DIFF_VERIFY` env var。设置→parse-walk（现状 diff=0）；未设→emit。cssnano 不动。D-SM-1..4 冻。 | 2026-10-07 |
