...
| `fe-tools-bundler-strict-access` | `ready` | [README](fe-tools-bundler-strict-access/README.md) | tsconfig 启用 noUncheckedIndexedAccess（63 错待修）+ forceConsistentCasingInFileNames + allowUnusedLabels:false（零成本）；行为 0。Review R1+R2 pass。 | 2026-09-18 |
