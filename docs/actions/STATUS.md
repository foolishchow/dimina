...
| `render-target-abstraction` | `in_progress` | [README](render-target-abstraction/README.md) | Umbrella gate A4：view/style target 抽象，首个 `webview` 实现，产物与既有行为零变化；不实现 Lynx/rspack。P-001 实施中。 | 2026-09-08 |
