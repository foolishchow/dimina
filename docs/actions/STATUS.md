...
| `fe-tools-module-convergence` | `complete` | [README](_archive/complete/fe-tools-module-convergence/README.md) | Packer 形状伞：D-MC-0 A（code 不上图）；MC0 graph 正确 + MC3a deriveFromGraph 全 complete。MC3b/c/MC1/MC2 deferred。 | 2026-09-21 |
...
| `fe-tools-emit-relocate` | `draft` | [README](fe-tools-emit-relocate/README.md) | emit 从 compile-worker 搬到 emit-worker；打破 streaming；主线程分组+编排。D-ER-0..3 已定；D-ER-4..6 待讨论。 | 2026-09-21 |
