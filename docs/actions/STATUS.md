...
| `fe-tools-packer-research` | `draft` | [README](fe-tools-packer-research/README.md) | Packer extraction 可行性研究：4 焊点（emit.ts / logic/** / env.ts / dependency-graph.ts）方法级分析 + 可抽提性评估 + API 草案。research only。 | 2026-09-20 |