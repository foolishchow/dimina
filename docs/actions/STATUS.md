...
| `fe-tools-sidecar` | `draft` | [README](fe-tools-sidecar/README.md) | Umbrella（draft）；TS-2 deferred；layout complete；**TS-4** sync-rhythm 成文；近端候补：`runBuild` 阶段化（未 formalize）。 | 2026-09-12 |
