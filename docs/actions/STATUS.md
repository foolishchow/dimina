...
| `fe-tools-compiler-layering` | `draft` | [README](fe-tools-compiler-layering/README.md) | compiler 分层：L0 目录归位（两轴：域+core/pipeline；npm 归 core）→ L1 dom 抽象 → L2 napi 接入；L0 先独立合入；4 项待定。 | 2026-09-15 |
