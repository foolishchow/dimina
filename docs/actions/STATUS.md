...
| `fe-tools-module-convergence` | `in_progress` | [README](fe-tools-module-convergence/README.md) | Packer 形状伞：D-MC-0 A（code 不上图，非双字段）；MC0→MC3a；MC3b/c/MC1/MC2 deferred。实施中。 | 2026-09-21 |
