...
| `fe-tools-compiler-target` | `in_progress` | [README](fe-tools-compiler-target/README.md) | 产物形态切面收敛：CompileTarget + 阶段派生（E1–E8）；**T0+T1+T2 已交付**（525/75；消融 ×3 ✓；nomap94/sm185 diff=0）；待 Close / 回流。 | 2026-09-14 |
