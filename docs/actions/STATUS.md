...
| `fe-tools-bundler-boundaries` | `draft` | [README](fe-tools-bundler-boundaries/README.md) | Packer/Scheme 职责与目录/文件落点；不改 src。D-BD-5=焊点，D-BD-6=不下到方法。待定已清空；升 ready 另授。 | 2026-09-18 |
