...
| `fe-tools-fingerprints-persist` | `draft` | [README](fe-tools-fingerprints-persist/README.md) | watch-plan 持久化 fingerprints 到 PackerSessionState；content-based dedup 过滤 mtime-only false positives。增量前置 G2。 | 2026-10-07 |
