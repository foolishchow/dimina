...
| `fe-tools-bundler-boundaries` | `in_progress` | [README](fe-tools-bundler-boundaries/README.md) | Packer/Scheme 职责与目录/文件落点；不改 src。D-BD-1..6 全拍板；落点表封口全集；授权实施步骤 3-5。 | 2026-09-18 |
