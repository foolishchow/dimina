...
| `fe-tools-module-convergence` | `draft` | [README](fe-tools-module-convergence/README.md) | Module 收敛伞：MC0 graph 正确性 → MC1 GraphNode 加 code → MC2 view 入图 → MC3 BuildModel 派生。承接 module-centric 伞半套资产。D-MC-* 待冻结。 | 2026-09-21 |
