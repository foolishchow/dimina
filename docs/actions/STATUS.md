...
| `fe-tools-wxml-bridge` | `draft` | [README](fe-tools-wxml-bridge/README.md) | Rust parser napi 桥 + sourcemap 跨文件归位（include 错位修复）；crates workspace 就绪（483 tests）；D-WB-1..3 已拍板；6 项待定后升 ready。 | 2026-09-14 |
