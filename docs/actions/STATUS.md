...
| `fe-tools-emit-w1-parameterize` | `draft` | [README](fe-tools-emit-w1-parameterize/README.md) | 焊点 1（emit.ts）纯化：EmitEntryParams 加 workPath 参数替代 getWorkPath() 全局函数调用；emit.ts 0 env.ts 依赖。S 级行为 0 重构。前置 fe-tools-packer-research W1 决策。 | 2026-09-21 |
