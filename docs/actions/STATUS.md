...
| `fe-tools-emit-relocate` | `ready` | [README](fe-tools-emit-relocate/README.md) | emit 从 compile-worker 搬到 emit-worker；打破 streaming；主线程分组+编排。D-ER-0..7 全冻结。 | 2026-09-21 |
