...
| `fe-tools-compiler-layering` | `in_progress` | [README](fe-tools-compiler-layering/README.md) | compiler 目录归位（方案 A 两轴 + 61 函数穷举 + WORKER_ENTRY 映射 + 根级 index.js 删除）；纯移动唯一门，行为 0；L0 实施已授权（基线 `5c4ce74f`）。 | 2026-09-15 |
