...
| `dmcc-dev-server` | `draft` | [README](dmcc-dev-server/README.md) | Umbrella gate A2：`dmcc dev` 一条命令交付 dev 链路（watch + 静态服务 + 内置宿主页 + ws + 代理 + L1 relaunch）。A1/A2.0 前置已解除。 | 2026-09-08 |
