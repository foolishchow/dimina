...
| `fe-tools-emit-relocate` | `ready` | [README](fe-tools-emit-relocate/README.md) | emit 从 compile-worker 搬到 emit-worker；打破 streaming；结构化 `emitBuckets`（同 writeCompileRes 分桶）+编排。D-ER-0..7 全冻结。 | 2026-09-20 |
