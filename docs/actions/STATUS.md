...
| `fe-tools-bundler-tsc-dist` | `ready` | [README](fe-tools-bundler-tsc-dist/README.md) | B2：tsc emit 全 src；删 sync、留 postbuild；第0/1刀迁 ts；**R1 修正 D-TD-17..19**（TS5055 包名化前置 + exports/compat 漂移热修——npm build/test 当前必炸）；实施待授权。 | 2026-09-15 |
