...
| `fe-tools-bundler-typecheck` | `in_progress` | [README](fe-tools-bundler-typecheck/README.md) | allowJs + CI tsc --noEmit（fe-tests.yml）；S0+S1（含 load/index.js）；strict；集中 typedef；行为 0 MUST；实施中。 | 2026-09-15 |
