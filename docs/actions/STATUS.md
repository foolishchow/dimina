...
| `fe-tools-compiler-target` | `in_progress` | [README](fe-tools-compiler-target/README.md) | 产物形态切面收敛：CompileTarget 描述 + 阶段派生（E1–E8 实锚）；T0/T1/T2 三门；D-CT-0..5 已拍板；**T0 已交付**（502/502 + diff=0 + 消融 ✓）；T1/T2 待授权。 | 2026-09-14 |
