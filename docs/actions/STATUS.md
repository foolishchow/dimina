...
| `fe-tools-graph-persist` | `ready` | [README](fe-tools-graph-persist/README.md) | storeInfo state 路径走 reconcile（非 build），保留旧图 source-level edges。D-GP-1..4 冻。3 轮 review clean。增量前置 G1。 | 2026-10-07 |
