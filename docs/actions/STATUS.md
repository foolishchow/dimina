...
| `fe-tools-wxml-parser-dist` | `in_progress` | [README](fe-tools-wxml-parser-dist/README.md) | P0 已交付（`c2d792de`）：最小平台加载 + `*.node` 退 git + CI Rust 步骤；本地 580/580 + 消融 ✓；**待 push 后 CI 绿**；binding.js 根因（CLI3 vs napi-derive2）P1 对齐。 | 2026-09-15 |
