...
| `fe-tools-bundler-tsc-dist` | `ready` | [README](fe-tools-bundler-tsc-dist/README.md) | B2：tsc emit 全 src；删 sync、留 postbuild；第0/1刀迁 ts；D-TD-16 type-only emit；实施待授权。 | 2026-09-15 |
