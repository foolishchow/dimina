...
| `fe-tools-bundler-tsc-dist` | `in_progress` | [README](fe-tools-bundler-tsc-dist/README.md) | B2：tsc emit 全 src；删 sync、留 postbuild；第0/1刀迁 ts；T0a 前置修复（TS5055/exports）→ T0b build 改道 → T1 迁 ts → T2 行为 0；基线 `33bda111`；D-TD-19 已先行合入。 | 2026-09-15 |
