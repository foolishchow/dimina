...
Status: **complete（2026-09-12）** — BP1 闭门；A-BP01..05 全 pass；消融 ×1
...
| A-BP02 | R-BP2 | vitest 全绿；nomap 相对基线 diff=0；CLI build/watch/dev 冒烟 **SHOULD** | P-BP01 / P-BP02（+ CLI 若做） | **pass** — 485 tests / 73 suites 全绿；nomap 94 / sourcemap 185 diff=0（对照 aa6b6508）；base 工程 build 冒烟通过 |
...
- Evidence 列以 `P-BP*` 为主。  
- 设计已冻结 v1；**BP1 已交付并归档（2026-09-12）**；证据见 [validation](validation.md)（含 M-A 消融 §A）。
