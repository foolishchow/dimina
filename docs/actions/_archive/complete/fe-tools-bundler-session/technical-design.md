...
- [`src/index.ts`](../../../../../fe/tools/bundler/src/index.ts)：`build` / `runBuild` + Listr 阶段手写
- [`src/watch/watch-runner.ts`](../../../../../fe/tools/bundler/src/watch/watch-runner.ts)：`createBuildWatcher`（lifecycle 经 `options.lifecycle` 注入）
- [`src/bin/dev.ts`](../../../../../fe/tools/bundler/src/bin/dev.ts)：D1a 手拼串联
- [`src/bin/index.ts`](../../../../../fe/tools/bundler/src/bin/index.ts)：`build` / `build -w` 手拼
- [`src/shared/lifecycle.ts`](../../../../../fe/tools/bundler/src/shared/lifecycle.ts)：A1 事件契约 v1（内部）
- [`src/dev/dev-server.ts`](../../../../../fe/tools/bundler/src/dev/dev-server.ts)：preview server
- [`src/bin/compile.ts`](../../../../../fe/tools/bundler/src/bin/compile.ts)：**范围外**——bootstrap 复制残留、无消费者（fe 的 `compile` script 指向 packages/compiler 侧同名文件）；不经 session，本门不动
