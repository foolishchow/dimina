...
- [`src/common/watch-runner.js`](../../../../../fe/tools/bundler/src/watch/watch-runner.js)：`createBuildWatcher`（lifecycle 经 `options.lifecycle` 注入）
...
- [`src/common/lifecycle.js`](../../../../../fe/tools/bundler/src/shared/lifecycle.js)：A1 事件契约 v1（内部）
- [`src/common/dev-server.js`](../../../../../fe/tools/bundler/src/dev/dev-server.js)：preview server
