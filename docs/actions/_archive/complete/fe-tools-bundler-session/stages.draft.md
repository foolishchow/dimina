...
Authoritative code today: [`fe/tools/bundler/src/index.ts`](../../../../../fe/tools/bundler/src/index.ts) (`runBuild`), [`env.ts`](../../../../../fe/tools/bundler/src/compiler/core/env.ts), [`core/*`](../../../../../fe/tools/bundler/src/compiler/).
