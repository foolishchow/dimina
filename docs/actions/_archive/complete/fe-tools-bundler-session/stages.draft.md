...
Authoritative code today: [`fe/tools/bundler/src/index.ts`](../../../../../fe/tools/bundler/src/index.ts) (`runBuild`), [`env.ts`](../../../../../fe/tools/bundler/src/packer/store/env.ts), [`core/*`](../../../../../fe/tools/bundler/src/compiler/).
