...
Authority: [architecture-notes.md](./architecture-notes.md) · [`fe-tools-project-store`](../actions/_archive/complete/fe-tools-project-store/README.md) · [`fe-tools-build-pipeline`](../actions/_archive/complete/fe-tools-build-pipeline/README.md)
